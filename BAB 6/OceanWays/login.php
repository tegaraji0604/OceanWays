...
<head>
    ...
    <style>
        /* Mengatur margin dan padding seluruh elemen menjadi nol */
* {
    margin: 0;
    padding: 0;
...
/* Memberikan gaya pada container form */
.container {
...
/* Memberikan margin bawah pada elemen h2 */
h2 {
    margin-bottom: 20px;
    text-align: center;
    color: #333333;
